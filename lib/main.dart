                       ...
                       // width: double.infinity,
                        child: Column(
                          children: [
                                                          ...
                                                          onPressed: () async {
                                                            final response =
                                                                await httpRequest(
                                                                    REQUEST_TYPE
                                                                        .DELETE,
                                                                    ('${baseUrl}post/delete/${provider.album[index].id.toString()}'),
                                                                    {});
                                                            if (response
                                                                    .statusCode ==
                                                                200) {
                            ...
                            Container(
                              color: HexColor(
                                  provider.album[index].background.toString()),
                             ...
                             // padding: EdgeInsets.only(top: 135),
                              child: Column(
                                children: [
                                  ...
                                  Text(provider.album[index].post.toString(),
                                      style: TextStyle(
                                          fontSize: 30, color: Colors.blue)),
                                  Text(
                                    provider.album[index].created_at.toString(),
                                    style: TextStyle(
...
//     style:TextStyle(fontSize: 20,color: Colors.red)),
                                  Text(
                                    provider.album[index].updated_at.toString(),
                                    style: TextStyle(
                                        fontSize: 20, color: Colors.black),
                                  ),
                                ],
